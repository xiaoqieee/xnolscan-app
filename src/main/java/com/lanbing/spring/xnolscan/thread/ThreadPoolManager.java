...
public class ThreadPoolManager {
    ...
    // 线程池维护线程的最少数量,工作线程
    public static final int CORE_POOL_SIZE = CORE;

    // 线程池维护线程的最大数量
    public static final int MAX_POOL_SIZE = CORE;

    // 线程池维护线程所允许的空闲时间,单位由TimeUnit定义
    public static final int KEEP_ALIVE_TIME = 3;

    // 线程池所使用的缓冲队列大小
    public static final int WORK_QUEUE_SIZE = 4096;
    ...
    public static final ThreadPoolExecutor threadPool = new ThreadPoolExecutor(CORE_POOL_SIZE, MAX_POOL_SIZE,
            KEEP_ALIVE_TIME, TimeUnit.MINUTES, new ArrayBlockingQueue<>(WORK_QUEUE_SIZE),
