...
public class CookieHelper {
    ...
    private static String[] queryCookies = {
            ...
            ,
            "sr=331271.43.11.3.116.7.225.146.0.33.20.15.07; SESSIONID=5c14955a-04f2-40d3-b411-fb5af22999f9; JSESSIONID=1D370E3301629E97DF2A2322AB72A7F9.t-9003; _ga=GA1.2.10432794.1551412207; _gid=GA1.2.154113236.1551412207; _gat=1; lcksid=5c78ac0fe95072007c2d8033; referer=\"https://www.xiaoniu88.com/user/_2019-03-01\""
    };

    private static AtomicInteger count = new AtomicInteger(0);

    public static void initCookie() {
        Map<String, String> cookieMap = DataToDiscUtils.getCookieMap();
        if (cookieMap != null) {
            buyCookie = cookieMap.get(BizConfigHelper.get(ConfigKey.BUY_USER_USERNAME));
            int i = 0;
            queryCookies = new String[cookieMap.values().size()];
            for (String cookie : cookieMap.values()) {
                queryCookies[i++] = cookie;
            }
        }
    }
